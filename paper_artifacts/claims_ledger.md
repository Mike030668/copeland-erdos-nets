...
| **C3** | Results are consistent with a spectral/gain conditioning mechanism | Supported | R008b (Gain sweep) | Fig 02, Fig 03 | High sensitivity to specific gain (1.2). No direct attention-logit diagnostics. |
...
- The method is proven for large LLMs: Experiments were limited to small decoder-only Transformers (~13–29 M total parameters, of which the vast majority are embedding parameters).
